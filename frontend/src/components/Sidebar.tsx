...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-12 bottom-0 w-52 bg-[#0a0a0a] border-r border-[#151515] flex flex-col">
      {/* logo */}
      <Link href="/overview" className="flex items-center gap-2 px-4 h-12 border-b border-[#151515]">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm lowercase transition-colors ${
                active ? "text-white bg-[#111]" : "text-[#555] hover:text-white hover:bg-[#0f0f0f]"
              }`}
            >
              <item.icon size={16} />
              {item.label}
